const products=[
  {
    ...
    generics: "Novartis(Bangladesh) Limited",
    price: 30.4,
    introduction:
    ...
    img: "https://i.ibb.co/fSTkWJh/camera.jpg",
    rating: 1,
    stock: 0
  },
  {
    id: "2",
    name: "Comet 500",
    generics: "Metformin Hydrochloride 500mg",
    price: 5.7,
    introduction:
      "Treatment of type 2 diabetes mellitus, especially in overweight people, when food and exercise alone are unable to provide appropriate glycemic control.Metformin can be used alone or in conjunction with other oral antidiabetic drugs or insulin in adults.Metformin can be taken alone or in conjunction with insulin in children and adolescents as young as ten years old.In overweight type 2 diabetes adult patients treated with metformin as first-line treatment following diet failure, there was a decrease in diabetic complications.",
    img: "https://i.ibb.co/CVxw9zt/alexa.jpg",
    rating: 4,
    stock: 3
  },
  {
    id: "3",
    name: "Napa Extra",
    generics: "Beximco Pharmaceuticals Ltd",
    price: 2.38,
    introduction:
    ...
    img: "https://i.ibb.co/8zJTVcD/airpods.jpg",
    rating: 2.5,
    stock: 3
  },
  {
    id: "4",
    name: "Linatab M 2.5/500",
    generics: "Incepta Pharmaceuticals Ltd",
    price: 11.4,
    introduction:
    ...
    img: "https://i.ibb.co/WG9bDrZ/sample.jpg",
    rating: 2,
    stock: 3
  },
  {
    id: "5",
    name: "Dialiptin-M 500",
    generics: "Drug International Limited",
    price: 11.4,
    introduction:
    ...
    img: "https://i.ibb.co/JyHQ8hx/phone.jpg",
    rating: 4.5,
    stock: 3
  },
  {
    id: "6",
    name: "Seclo 20",
    generics: "Square Pharmaceuticals Limited",
    price: 7.4,
    introduction:
      "Omeprazole is used to treat the following conditions ,Duodenal and gastric ulcers,Duodenal and stomach ulcers caused by NSAIDs,As a preventative measure in individuals with a history of NSAID-related duodenal and stomach ulcers. GERD is an abbreviation for gastroesophageal reflux disease.Long-term acid reflux disease management",
    img: "https://i.ibb.co/F58M3X3/playstation.jpg",
    rating: 3.5,
    stock: 3,
  },
  {
    ...
    img: "https://i.ibb.co/zNBrXnw/mouse.jpg",
    rating: 5,
    stock: 3,
  }
]
